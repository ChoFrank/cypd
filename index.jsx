...
class App extends React.Component {
    ...
    render() {
        ...
        const rows = [
            ...
            [<Icon type='led-yellow' />, <Button type='primary' icon='stop' iconColor='white'>Nickname</Button>, <Button>IP addr</Button>, <Button icon='square-minus' type='danger'>gateway</Button>],
