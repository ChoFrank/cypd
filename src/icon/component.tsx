...
const next = (props: SVGProps) => ([
    <path d='M4 2 4 14 12 8Z' style={{ fill: props.color }} key={`1_${props.svgId}`} fill='none' />,
    <path d='M12 2.5 12 13.5' style={{ fill: props.color, stroke: props.color }} strokeWidth={2} key={`2_${props.svgId}`} fill='none' />,
]);

const previous = (props: SVGProps) => ([
    <path d='M12 2 12 14 4 8Z' style={{ fill: props.color }} key={`1_${props.svgId}`} fill='none' />,
    <path d='M4 2.5 4 13.5' style={{ fill: props.color, stroke: props.color }} strokeWidth={2} key={`2_${props.svgId}`} fill='none' />,
]);
...
const scissors = (props: SVGProps) => ([
    ...
    <path d='M7.36 7.36 10 16 6.5 15 Z' style={{ stroke: props.color }} fill='transparent' key={`5_${props.svgId}`} />,
    <path d='M7.36 7.36 16 10 15 6.5 Z' style={{ stroke: props.color }} fill='transparent' key={`6_${props.svgId}`} />,
    <circle cx="7.5" cy="7.5" r="0.1" key={`7_${props.svgId}`} fill="transparent" />,
]);
