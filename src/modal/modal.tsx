    ...
    render() {
        ...
        return (
            <div className={wrapperClass}>
                <div className='cypd-modal-background' onClick={props.onClose}></div>
                <div className={modalClass} style={this.props.style} onClick={(e) => { e.stopPropagation(); }}>
                    {(props.onClose) ? <svg className='close-svg' onClick={props.onClose}><path d='M4 4 16 16 M4 16 16 4' stroke='white' strokeWidth={3} /></svg> : undefined}
